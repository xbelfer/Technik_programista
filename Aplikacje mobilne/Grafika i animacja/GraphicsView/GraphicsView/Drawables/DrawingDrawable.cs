...
namespace GraphicsView.Drawables
{
    ...
    internal class ImageDrawable : IDrawable
    {
        public void Draw(ICanvas canvas, RectF dirtyRect)
        {
            ...
            using (Stream stream = assembly.GetManifestResourceStream("GraphicsView.Resources.Images.dotnet_bot.png"))
            {
    ...
    internal class DownsizeImageDrawable : IDrawable
    {
        public void Draw(ICanvas canvas, RectF dirtyRect)
        {
            ...
            if (image != null)
            {
                IImage newImage = image.Downsize(200, true);
    ...
    internal class ClippingDrawable : IDrawable
    {
        public void Draw(ICanvas canvas, RectF dirtyRect)
        {
            ...
            using (var stream = assembly.GetManifestResourceStream("GraphicsView.Resources.Images.dotnet_bot.png"))
            {
                image = PlatformImage.FromStream(stream);
            }
